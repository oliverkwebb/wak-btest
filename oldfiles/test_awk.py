...
default_progs = 'nnawk gawk mawk goawk bbawk tbawk asawk'
default_progs = 'nnawk gawkc gawkp gawk bbawk tbawk aswak'
default_progs = 'nnawk gawk mawk goawk tbawk asawk aswak'
default_progs = 'nnawk gawk mawk goawk bbawk tbawk asawk aswak'
default_progs = 'nnawk gawk mawk goawk bbawk asawk wak'
default_progs = 'nnawk gawk mawk goawk bbawk tbawk otbawk'
default_progs = 'nnawk gawk mawk goawk bbawk wak prwak'
default_progs = 'nnawk gawk mawk goawk bbawk otbawk tbawk omuwak muwak'
default_progs = 'nnawk gawk mawk goawk bbawk asawk aswak xwak'
default_progs = 'nnawk gawk mawk goawk bbawk asawk aswak xwak'
default_progs = 'nnawk gawk mawk goawk bbawk tbawk muwak'
default_progs = 'otbawk tbawk oxwak xwak omuwak muwak omwak mwak'
default_progs = 'nnawk gawk mawk goawk bbawk asawk aswak'
default_progs = 'gawk nnawk mawk goawk bbawk asawk aswak'
default_progs = 'gawk nnawk mawk goawk bbawk tbawk muwak'
...
def test_files(fns, optns):
    ...
    while fns:
        ...
        if not isfile(fn):
            continue
        if k % 10 == 0:
            print_progs_hdr(optns.progs)
        k += 1

        errs = []
        info = []
        printf('Test %-24s ', os.path.basename(fn))
...
def main():
    ...
    #print(' '.join(sys.argv))
    optns = type('optns', (), {})()
    optns.progs = default_progs.split()
    optns.pdir = ''
